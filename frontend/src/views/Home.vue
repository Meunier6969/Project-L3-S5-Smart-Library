  ...
  data() {
    return {
      bookList: [
        ...
        new Book(5, "Harry Potter and the Chamber of Secrets and His Huge Boat which Sinked in the Sea", "J.K. Rowling", "https://m.media-amazon.com/images/I/918wxhKJaPL._SL1500_.jpg", ["Fantasy", "Magic"], ),
      ],
      favList: [1, 3, 7],
    };
  },
