...
INSERT INTO Book (title, author, description, years, img, search_count, category_id)
VALUES ('The Lord of the Rings', 'J.R.R. Tolkien', '"The Lord of the Rings" is an epic high-fantasy novel that follows the quest to destroy the One Ring, an artifact of great power that could bring ruin to the world if it falls into the hands of the Dark Lord Sauron. With richly developed characters and settings, Tolkien creates a timeless adventure about courage, friendship, and the struggle between good and evil.', '1954-07-29', 'https://m.media-amazon.com/images/I/51t0Z0DfEfL._SL1500_.jpg', 720000, 1);

INSERT INTO Book (title, author, description, years, img, search_count, category_id)
VALUES ('Gone Girl', 'Gillian Flynn', '"Gone Girl" is a psychological thriller that explores the marriage of Nick and Amy Dunne, whose relationship unravels when Amy disappears on their fifth wedding anniversary. As the investigation unfolds, secrets are revealed, and nothing is as it seems. The novel keeps readers on edge with its twists and dark insights into relationships and media sensationalism.', '2012-06-05', 'https://m.media-amazon.com/images/I/61mcHA1yJLL._SY522_.jpg', 450000, 2);

INSERT INTO Book (title, author, description, years, img, search_count, category_id)
VALUES ('Dune', 'Frank Herbert', '"Dune" is a science fiction epic set on the desert planet Arrakis, where water is scarce, and a valuable spice called melange is the key to interstellar travel. The novel follows young Paul Atreides as he navigates political intrigue, rebellion, and prophecy. "Dune" explores themes of power, religion, and environmentalism in a rich, detailed universe.', '1965-08-01', 'https://m.media-amazon.com/images/I/51eWmFnkjfL._SY445_SX342_.jpg', 620000, 1);

INSERT INTO Book (title, author, description, years, img, search_count, category_id)
VALUES ('The Da Vinci Code', 'Dan Brown', '"The Da Vinci Code" is a fast-paced thriller that follows Harvard symbologist Robert Langdon as he unravels a series of puzzles and mysteries related to the secret of the Holy Grail. Set against a backdrop of historical intrigue and conspiracy theories, the novel blends art, religion, and cryptology into an international adventure.', '2003-03-18', 'https://m.media-amazon.com/images/I/41LPTao7wdL._SY445_SX342_.jpg', 510000, 2);
